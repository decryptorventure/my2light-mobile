...
test("concurrent sessions are isolated (NO race condition)", () => {
    ...
    assertTrue(
        resultA2.resetLayer === null || resultA2.resetLayer === undefined,
    ...
    assertTrue(
        resultB2.resetLayer === null || resultB2.resetLayer === undefined,
...
test("explicit reset marker triggers reset", () => {
    ...
    assertTrue(
        result.resetLayer && result.resetLayer.includes("marker"),
        "Should detect marker reset"
    );
    assertEqual(result.percentage, 0, "Percentage should reset to 0%");
});
...
test("3 concurrent sessions remain isolated", () => {
    ...
    const r1 = trackContext({
        sessionId: "sess-1",
        contextInput: 15000,
        contextOutput: 15000,
        contextWindowSize: 200000,
    });
    const r2 = trackContext({
        sessionId: "sess-2",
        contextInput: 15000,
        contextOutput: 15000,
        contextWindowSize: 200000,
    });
    const r3 = trackContext({
        sessionId: "sess-3",
        contextInput: 15000,
        contextOutput: 15000,
        contextWindowSize: 200000,
